...
| 优先级 | P0（前置） |
| 状态 | ✅ 已完成（核心实现；项目级绑定配置 UI 随 R-07、R-10 启动联调在 R-10 验证） |
| 依赖 | - |
...
- [ ] 项目绑定 JDK 后，R-10 启动实际使用该 JDK（联调验证）— 留给 R-10
...
- 当前状态：已完成（核心实现交付；项目级绑定配置 UI 随 R-07、R-10 启动联调在 R-10 验证）
- 最近更新：2026-08-19 完成核心实现
