...
> 非桌面化方案拆解任务，来自用户需求（来源与方案见各任务文档）。

| 编号 | 任务 | 优先级 | 状态 | 依赖 | 文档 |
|---|---|---|---|---|---|
| D-17 | 关于页 + 应用内更新（Tauri Updater 前端接入） | P1 | ✅ | — | [D-17-about-updater.md](./D-17-about-updater.md) |
...
- D-17 为独立增量任务（用户需求 2026-08-29），无前置依赖，不与其他任务互锁。
