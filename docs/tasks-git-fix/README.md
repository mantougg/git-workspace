...
| GF-23 | RepositoryList 侧栏提交图预览面板高度链断裂（`.graph-pane-spin` 缺 `:deep(.n-spin-content)`，裁切不可滚动） | P2 | ⬜ | [GF-23-repositorylist-graph-pane-height-chain.md](./GF-23-repositorylist-graph-pane-height-chain.md) |
