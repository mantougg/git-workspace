...
This project is indexed by GitNexus as **git-workspace** (9194 symbols, 19679 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
