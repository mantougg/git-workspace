...
This project is indexed by GitNexus as **git-workspace** (8721 symbols, 18765 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
