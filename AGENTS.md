...
This project is indexed by GitNexus as **git-workspace** (9639 symbols, 20858 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
