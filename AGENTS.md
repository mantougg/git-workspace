...
This project is indexed by GitNexus as **git-workspace** (6606 symbols, 15045 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
