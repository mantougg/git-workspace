...
This project is indexed by GitNexus as **git-workspace** (10671 symbols, 23637 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
